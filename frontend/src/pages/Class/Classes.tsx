...
function Classes() {
  ...
  const { sections, addSection, assignClassTeacher,
          loadAllSections }                                          = useSections();
  ...
  /* ── Load all sections from backend on mount ── */
  useEffect(() => {
    loadAllSections();
  }, []);
  ...
  const selectedClass  = orderedClasses.find((c) => c.id === selectedClassId) ?? null;
  ...
  /* ── Add section — async backend call (from main) ── */
            ...
            {orderedClasses.map((cls, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Card body — stopPropagation so clicking input doesn't select card */}
                  <div
                  ...
                  >
                    ...
                    <div className="cls-add-row">
                      <input
                        ...
                        onChange={(e) =>
                          handleSectionInput(cls.id, e.target.value)
                        }
                        onKeyDown={(e) => {
